 ...
 * number of subspace iterations in {@link math.rsvd.ApproximateBasis} is fixed,
 * and the rank criterion behind {@code ApproximateBasis.decompose} comes from a
 * different paper altogether (Matan Gavish and David L. Donoho. The optimal hard
 * threshold for singular values is 4 / sqrt(3). IEEE Transactions on Information
